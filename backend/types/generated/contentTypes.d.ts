...
export interface ApiAfficheAffiche extends Schema.CollectionType {
  ...
  attributes: {
    affiche_image: Attribute.Media<'images'>;
...
export interface ApiAvatarAvatar extends Schema.CollectionType {
  ...
  attributes: {
    avatarImage: Attribute.Media<'images'>;
    users: Attribute.Relation<
      'api::avatar.avatar',
      'oneToMany',
      'plugin::users-permissions.user'
...
export interface ApiCommandeCommande extends Schema.CollectionType {
  ...
  attributes: {
    ...
    users_permissions_user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    dateCommande: Attribute.DateTime;
